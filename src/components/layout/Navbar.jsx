            ...
            <nav className=" mb-4 border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <NavLink to="/" className="flex items-center">
                        <img className='w-12 h-12 mr-2 rounded-full' src="https://www.svgheart.com/wp-content/uploads/2020/09/-60.png" alt="logo" />
                    ...
                    <div className="flex md:order-2">
                        ...
                        {
                            user && <div><img data-tooltip-id="my-tooltip" data-tooltip-content={user.displayName} className='w-10 h-10 mr-2 rounded-full' src={user.photoURL} alt="" />
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <NavLink
                                to="/" className="hover:underline block py-2 pl-3 pr-4 text-gray-900 bg-blue-700 rounded md:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">RECIPES
                            </NavLink>
                            ...
                            <NavLink to="/about" className="block hover:underline py-2 pl-3 pr-4 text-gray-900 rounded bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">ABOUT
                            </NavLink>
                        </ul>
                    </div>
                </div>
